...
New Version of the script with additional tables:

-- =======================================================
-- Database variables
-- =======================================================
:SETVAR NovaBaza "IpsEnergy193_SLAN"        -- Target Database
:SETVAR StaraBaza "IpsEnergy193_SLAN_20260622" -- Source Database
...
ALTER TABLE [$(NovaBaza)]..UsrFunctionsGroups  NOCHECK CONSTRAINT ALL;
GO
ALTER TABLE [$(NovaBaza)].sch.EmployeeTeam		NOCHECK CONSTRAINT ALL;
GO
ALTER TABLE [$(NovaBaza)].sch.Employee         NOCHECK CONSTRAINT ALL;
GO
ALTER TABLE [$(NovaBaza)].sch.Team             NOCHECK CONSTRAINT ALL;
...
-- EmployeeTeam
DELETE FROM [$(NovaBaza)].sch.EmployeeTeam;
GO
INSERT INTO [$(NovaBaza)].sch.EmployeeTeam
SELECT * FROM [$(StaraBaza)].sch.EmployeeTeam;
GO
...
-- Team
DELETE FROM [$(NovaBaza)].sch.Team;
GO
INSERT INTO [$(NovaBaza)].sch.Team 
SELECT * FROM [$(StaraBaza)].sch.Team;
GO
...
ALTER TABLE [$(NovaBaza)]..UsrFunctionsGroups  WITH CHECK CHECK CONSTRAINT ALL;
GO
ALTER TABLE [$(NovaBaza)].sch.EmployeeTeam		WITH CHECK CHECK CONSTRAINT ALL;
GO
ALTER TABLE [$(NovaBaza)].sch.Employee         WITH CHECK CHECK CONSTRAINT ALL;
GO
ALTER TABLE [$(NovaBaza)].sch.Team             WITH CHECK CHECK CONSTRAINT ALL;
