...
/*
-- Ovo radimo na bazi sa koje cemo prepisivati
--  a komande ce se pustati na bazi na koju prepisujemo
...
-- modify database names according to your environment
	DECLARE @DatabaseFROM NVARCHAR(200) = '[IpsIdentityProvider_PCIC_Entergy]'
	DECLARE @DatabaseTO NVARCHAR(200) = '[IpsIdentityProvider_PCIC]'
